...
message(paste0("Total number of cells: ", length(colnames(seurat))))
gene.filter <- gene.filter[gene.filter %in% rownames(seurat)]
...
message(paste0("Total number of cells after filtering: ", length(colnames(seurat))))
